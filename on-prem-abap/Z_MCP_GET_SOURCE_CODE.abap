...
*--- BAdI Implementation ---
    WHEN 'BADI' OR 'BADI_NEW'.
      ...
      " Try reading the object as a class implementation include
      " (works when the object name is the implementing class)
      lv_badi_cls = iv_object_name.
